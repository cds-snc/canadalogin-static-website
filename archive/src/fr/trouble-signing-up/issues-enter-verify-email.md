...
translationKey: issuesEnterVerifyEmail
layout: 'layouts/base.njk'
eleventyNavigation:
  key: issuesEnterVerifyEmailFr
...
* Si votre boîte de réception est gérée par une équipe de TI (travail ou école), consultez cette équipe pour vous assurer que votre adresse courriel n'est pas bloquée.
...
Si vous avez reçu un courriel indiquant que votre adresse courriel est déjà associée à un compte Connexion GC, voici ce que cela signifie et ce que vous pouvez faire.
...
- {% linkRef links.troublesigningin '' 'Problèmes liés à la vérification en 2 étapes' %}
...
* Si vous avez d'autres questions ou si vous avez besoin d'aide supplémentaire, {% linkRef links.contact '' 'contactez l\'équipe de soutien à la clientèle' %}.
