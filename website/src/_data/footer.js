module.exports = {
  en: {
    contextual: {
      ...
      contactPartnersUrl: 'https://forms-formulaires.alpha.canada.ca/en/id/cmm9f6wbk01j2x30100mzljyl'
    },
    sub: {
      ...
      termsUsers: 'Terms and conditions',
      termsUsersUrl: '/en/users/terms/',
      termsPartners: 'Terms and conditions',
      termsPartnersUrl: '/en/partners/terms-and-conditions/',
      privacy: 'Privacy',
  ...
  fr: {
    contextual: {
      ...
      contactPartnersUrl: 'https://forms-formulaires.alpha.canada.ca/fr/id/cmm9f6wbk01j2x30100mzljyl'
    },  
    sub: {
