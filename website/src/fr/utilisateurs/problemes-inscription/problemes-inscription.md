...
<ul class="list-disc mb-300">
  ...
  <li>{% linkRef links.issuesenterverifyemailFR 'un-message-indique-que-le-code-est-invalide' 'Un message indique que votre adresse courriel est déjà associée à un identifiant ConnexionCanada' %}</li>
</ul>
