...
6. Saisissez le code que vous avez reçu sur votre téléphone pour vérifier votre nouveau numéro de téléphone.
   ...
   <gcds-notice type="info" notice-title-tag="h3" notice-title="Guides connexes">
     <gcds-text>{% linkRef links.issuesenterverifyemail '' 'Problèmes liés à la saisie et à la vérification de votre numéro de téléphone' %}</gcds-text>
   </gcds-notice>
