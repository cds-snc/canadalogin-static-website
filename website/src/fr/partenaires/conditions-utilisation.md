...
<gcds-grid columns="minmax(0, 1fr)" columns-desktop="320px minmax(0, 1fr)" tag="div" container="xl" alignment="center">
    <gcds-side-nav class="hide-on-mobile">
        <gcds-nav-group
            ...
            open
        >
            <gcds-nav-link href="{{ links.termsofuseFR }}" current>Conditions d’utilisation</gcds-nav-link>
            <gcds-nav-link href="{{ links.slaFR }}" >Accord sur les niveaux de service</gcds-nav-link>
        </gcds-nav-group>
    </gcds-side-nav>
    <main id="mc" class="general-layout" data-pagefind-body>

        {% set articlePage = articles_fr['conditions-utilisation'] %}
